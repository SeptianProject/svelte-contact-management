    ...
    >
      ...
      {#each pages as page (page)}
        <a
          ...
          class={`px-4 py-2 ${page === search.page ? "bg-gradient text-white" : "bg-gray-700 text-gray-300 hover:bg-gray-600"} rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition-all duration-200 font-medium shadow-md`}
        >
          {page}
        </a>
      {/each}
